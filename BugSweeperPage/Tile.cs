...
namespace BugSweeperPage
{
    ...
    class Tile : Frame
    {
        ...
        static Tile()
        {
            flagImageSource = null; // ImageSource.FromResource("Samples.BugSweeper.Images.Xamarin120.png", System.Reflection.Assembly.GetCallingAssembly());
            bugImageSource = null; // ImageSource.FromResource("Samples.BugSweeper.Images.RedBug.png", System.Reflection.Assembly.GetCallingAssembly ());
        }
