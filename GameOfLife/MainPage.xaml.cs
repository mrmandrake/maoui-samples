...
namespace GameOfLife
{
    public partial class MainPage : ContentPage
    {
        ...
        Button runButton;
        Button clearButton;
        ScrollView aboutText;

        public MainPage()
        {
            this.InitializeComponent();
            absoluteLayout = this.FindByName<AbsoluteLayout>("absoluteLayout");
            runButton = this.FindByName<Button>("runButton");
            clearButton = this.FindByName<Button>("clearButton");
            aboutText = this.FindByName<ScrollView>("aboutText");
        ...
        void UpdateLayout()
        {
            ...
            for (int x = 0; x < cols; x++)
                ...
                {
                    LifeCell lifeCell = (LifeCell)absoluteLayout.Children[index];
                    lifeCell.Col = x;
                    lifeCell.Row = y;
